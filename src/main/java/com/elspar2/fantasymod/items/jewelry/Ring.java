...
public class Ring extends Item implements IBauble,IHasModel {
	...
	public void onWornTick(ItemStack itemstack, EntityLivingBase player) {
		if (itemstack.getItemDamage()==0 && player.ticksExisted%39==0) {
			switch (gemName) {
				case "amber":
					if (GetPotionFromString(ConfigHandler.AMBER_EFFECT, ConfigHandler.AMBER_STRENGTH_RING) != null) {
						player.addPotionEffect(GetPotionFromString(ConfigHandler.AMBER_EFFECT, ConfigHandler.AMBER_STRENGTH_RING)); 
					}
					break;
				case "amethyst":
					if (GetPotionFromString(ConfigHandler.AMETHYST_EFFECT, ConfigHandler.AMETHYST_STRENGTH_RING) != null) {
						player.addPotionEffect(GetPotionFromString(ConfigHandler.AMETHYST_EFFECT, ConfigHandler.AMETHYST_STRENGTH_RING));
					}
					break;
				case "angelite":
					if (GetPotionFromString(ConfigHandler.ANGELITE_EFFECT, ConfigHandler.ANGELITE_STRENGTH_RING) != null) {
						player.addPotionEffect(GetPotionFromString(ConfigHandler.ANGELITE_EFFECT, ConfigHandler.ANGELITE_STRENGTH_RING));
					}
					break;
				case "aquamarine":
					if (GetPotionFromString(ConfigHandler.AQUAMARINE_EFFECT, ConfigHandler.AQUAMARINE_STRENGTH_RING) != null) {
						player.addPotionEffect(GetPotionFromString(ConfigHandler.AQUAMARINE_EFFECT, ConfigHandler.AQUAMARINE_STRENGTH_RING));
					}
					break;
				case "blackOpal":
					if (GetPotionFromString(ConfigHandler.BLACK_OPAL_EFFECT, ConfigHandler.BLACK_OPAL_STRENGTH_RING) != null) {
						player.addPotionEffect(GetPotionFromString(ConfigHandler.BLACK_OPAL_EFFECT, ConfigHandler.BLACK_OPAL_STRENGTH_RING));
					}
					break;
				case "coral":
					if (GetPotionFromString(ConfigHandler.CORAL_EFFECT, ConfigHandler.CORAL_STRENGTH_RING) != null) {
						player.addPotionEffect(GetPotionFromString(ConfigHandler.CORAL_EFFECT, ConfigHandler.CORAL_STRENGTH_RING));
					}
					break;
				case "diamond":
					if (GetPotionFromString(ConfigHandler.DIAMOND_EFFECT, ConfigHandler.DIAMOND_STRENGTH_RING) != null) {
						player.addPotionEffect(GetPotionFromString(ConfigHandler.DIAMOND_EFFECT, ConfigHandler.DIAMOND_STRENGTH_RING));
					}
					break;
				case "emerald":
					if (GetPotionFromString(ConfigHandler.EMERALD_EFFECT, ConfigHandler.EMERALD_STRENGTH_RING) != null) {
						player.addPotionEffect(GetPotionFromString(ConfigHandler.EMERALD_EFFECT, ConfigHandler.EMERALD_STRENGTH_RING));
					}
					break;
				case "garnet":
					if (GetPotionFromString(ConfigHandler.GARNET_EFFECT, ConfigHandler.GARNET_STRENGTH_RING) != null) {
						player.addPotionEffect(GetPotionFromString(ConfigHandler.GARNET_EFFECT, ConfigHandler.GARNET_STRENGTH_RING));
					}
					break;
				case "jade":
					if (GetPotionFromString(ConfigHandler.JADE_EFFECT, ConfigHandler.JADE_STRENGTH_RING) != null) {
						player.addPotionEffect(GetPotionFromString(ConfigHandler.JADE_EFFECT, ConfigHandler.JADE_STRENGTH_RING));
					}
					break;
				case "lapis":
					if (GetPotionFromString(ConfigHandler.LAPIS_EFFECT, ConfigHandler.LAPIS_STRENGTH_RING) != null) {
						player.addPotionEffect(GetPotionFromString(ConfigHandler.LAPIS_EFFECT, ConfigHandler.LAPIS_STRENGTH_RING));
					}
					break;
				case "moonstone":
					if (GetPotionFromString(ConfigHandler.MOONSTONE_EFFECT, ConfigHandler.MOONSTONE_STRENGTH_RING) != null) {
						player.addPotionEffect(GetPotionFromString(ConfigHandler.MOONSTONE_EFFECT, ConfigHandler.MOONSTONE_STRENGTH_RING));
					}
					break;
				case "obsidian":
					if (GetPotionFromString(ConfigHandler.OBSIDIAN_EFFECT, ConfigHandler.OBSIDIAN_STRENGTH_RING) != null) {
						player.addPotionEffect(GetPotionFromString(ConfigHandler.OBSIDIAN_EFFECT, ConfigHandler.OBSIDIAN_STRENGTH_RING));
					}
					break;
				case "onyx":
					if (GetPotionFromString(ConfigHandler.ONYX_EFFECT, ConfigHandler.ONYX_STRENGTH_RING) != null) {
						player.addPotionEffect(GetPotionFromString(ConfigHandler.ONYX_EFFECT, ConfigHandler.ONYX_STRENGTH_RING));
					}
					break;
				case "opal":
					if (GetPotionFromString(ConfigHandler.OPAL_EFFECT, ConfigHandler.OPAL_STRENGTH_RING) != null) {
						player.addPotionEffect(GetPotionFromString(ConfigHandler.OPAL_EFFECT, ConfigHandler.OPAL_STRENGTH_RING));
					}
					break;
				case "orangeTopaz":
					if (GetPotionFromString(ConfigHandler.ORANGE_TOPAZ_EFFECT, ConfigHandler.ORANGE_TOPAZ_STRENGTH_RING) != null) {
						player.addPotionEffect(GetPotionFromString(ConfigHandler.ORANGE_TOPAZ_EFFECT, ConfigHandler.ORANGE_TOPAZ_STRENGTH_RING));
					}
					break;
				case "painite":
					if (GetPotionFromString(ConfigHandler.PAINITE_EFFECT, ConfigHandler.PAINITE_STRENGTH_RING) != null) {
						player.addPotionEffect(GetPotionFromString(ConfigHandler.PAINITE_EFFECT, ConfigHandler.PAINITE_STRENGTH_RING));
					}
					break;
				case "peridot":
					if (GetPotionFromString(ConfigHandler.PERIDOT_EFFECT, ConfigHandler.PERIDOT_STRENGTH_RING) != null) {
						player.addPotionEffect(GetPotionFromString(ConfigHandler.PERIDOT_EFFECT, ConfigHandler.PERIDOT_STRENGTH_RING));
					}
					break;
				case "ruby":
					if (GetPotionFromString(ConfigHandler.RUBY_EFFECT, ConfigHandler.RUBY_STRENGTH_RING) != null) {
						player.addPotionEffect(GetPotionFromString(ConfigHandler.RUBY_EFFECT, ConfigHandler.RUBY_STRENGTH_RING));
					}
					break;
				case "sapphire":
					if (GetPotionFromString(ConfigHandler.SAPPHIRE_EFFECT, ConfigHandler.SAPPHIRE_STRENGTH_RING) != null) {
						player.addPotionEffect(GetPotionFromString(ConfigHandler.SAPPHIRE_EFFECT, ConfigHandler.SAPPHIRE_STRENGTH_RING));
					}
					break;
				case "taaffeite":
					if (GetPotionFromString(ConfigHandler.TAAFFEITE_EFFECT, ConfigHandler.TAAFFEITE_STRENGTH_RING) != null) {
						player.addPotionEffect(GetPotionFromString(ConfigHandler.TAAFFEITE_EFFECT, ConfigHandler.TAAFFEITE_STRENGTH_RING));
					}
					break;
				case "tanzanite":
					if (GetPotionFromString(ConfigHandler.TANZANITE_EFFECT, ConfigHandler.TANZANITE_STRENGTH_RING) != null) {
						player.addPotionEffect(GetPotionFromString(ConfigHandler.TANZANITE_EFFECT, ConfigHandler.TANZANITE_STRENGTH_RING));
					}
					break;
				case "turquoise":
					if (GetPotionFromString(ConfigHandler.TURQUOISE_EFFECT, ConfigHandler.TURQUOISE_STRENGTH_RING) != null) {
						player.addPotionEffect(GetPotionFromString(ConfigHandler.TURQUOISE_EFFECT, ConfigHandler.TURQUOISE_STRENGTH_RING));
					}
					break;
				case "yellowTopaz":
					if (GetPotionFromString(ConfigHandler.YELLOW_TOPAZ_EFFECT, ConfigHandler.YELLOW_TOPAZ_STRENGTH_RING) != null) {
						player.addPotionEffect(GetPotionFromString(ConfigHandler.YELLOW_TOPAZ_EFFECT, ConfigHandler.YELLOW_TOPAZ_STRENGTH_RING));
					}
					break;
			}
		switch (materialName) {
			...
			case "mithril":
				if (GetPotionFromString(ConfigHandler.MITHRIL_EFFECT, ConfigHandler.MITHRIL_STRENGTH) != null) {
					...
					player.addPotionEffect(new PotionEffect(PotionBrokenMagicShield.INSTANCE,80,0,true,true));
